...
class OpenShiftCollector:
    ...
    def _buffer_signal(self, signal: RawSignal):
        """Buffer signal locally and publish to Kafka (non-blocking, fire-and-forget)."""
        self._signal_buffer.append(signal)
        try:
            from app.integrations.kafka_publisher import publish_raw_signal_async
            publish_raw_signal_async({
